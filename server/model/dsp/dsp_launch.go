...
type DspLaunch struct {
	...
	CrowdDirection  *string    `json:"crowdDirection" form:"crowdDirection" gorm:"comment:人群定向 1 不限制，2 定向，3排除;column:crowd_direction;size:10;"`                              //人群定向
	RegionDirection *string    `json:"regionDirection" form:"regionDirection" gorm:"comment:地域定向 1 不限制，2 定向，3排除;column:region_direction;size:10;"`                           //地域定向
	BrandDirection  *string    `json:"brandDirection" form:"brandDirection" gorm:"comment:品牌定向 1 不限制，2 定向，3排除;column:brand_direction;size:10;"`                              //品牌定向
